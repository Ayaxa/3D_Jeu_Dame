...
CAM_WIDTH = 640 
titre = "fenetre webcam"
titre_video = "ma_video_python.avi"
...
#cam = VideoStreamWidget('http://192.168.19.30:8081', titre, resize_width=CAM_WIDTH) # capture d'image par le réseau
